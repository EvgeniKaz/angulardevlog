...
module.exports = "<div class=\"card card-body mb-4\">\n  <form (ngSubmit)=\"onSubmit()\" >\n    <div class=\"form-group\">\n      <label for=\"log\">Add a Log:</label>\n      <input type=\"text\" \n      class=\"form-control\" \n      name=\"text\" \n      [(ngModel)]=\"text\" >\n    </div>\n    <button type=\"submit\" \n    class=\"btn btn-primary mr-2\" [disabled]=\"!this.text\">Add Log</button>\n    <button class=\"btn btn-info \" type=\"button\"\n    [hidden]=\"!this.text\" \n    (click)=\"clearState()\" >Clear</button>\n  </form>\n</div>"
...
var LogService = /** @class */ (function () {
    ...
    LogService.prototype.updateLog = function (log) {
        var _this = this;
        this.logs.forEach(function (current, index) {
            if (log.id === current.id) {
                _this.logs.splice(index, 1, log);
            }
        });
        localStorage.setItem('logs', JSON.stringify(this.logs));
    };
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\Angular\devlog\src\main.ts */"./src/main.ts");
